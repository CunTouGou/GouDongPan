...
import com.hgz.file.util.OperationLogUtil;
...
public class WebLogAcpect {
     ...
     */
    @Pointcut("@annotation(com.hgz.common.anno.MyLog)")
    public void webLog() {
    }
    ...
    /**
     * 后置返回通知：在方法正常结束后执行的通知，无论方法是否出现异常
     *
     * @param ret 切入点方法的返回值
     * @throws Throwable 如果方法出现异常，则会在此方法中抛出
     */
