...
import com.hgz.file.dto.file.CreateOfficeFileDTO;
import com.hgz.file.dto.file.EditOfficeFileDTO;
import com.hgz.file.dto.file.PreviewOfficeFileDTO;
import com.hgz.file.helper.ConfigManager;
import com.hgz.file.util.FileModel;
...
public class OfficeController {
    ...
    public RestResult<Object> createOfficeFile(@RequestBody CreateOfficeFileDTO createOfficeFileDTO) {
        ...
        try{
            ...
            // String url2 = ClassUtils.getDefaultClassLoader().getResource(templateFilePath).getPath();
            String url2 = this.getClass().getClassLoader().getResource(templateFilePath).getPath();
        ...
        if ("2".equals(status) || "6".equals(status)) {
            ...
            if("edit".equals(type)){//修改报告
                ...
                try {
                    ...
                    InputStream inputStream = fileoperationFactory.getDownloader(fileBean.getStorageType()).getInputStream(downloadFile);
